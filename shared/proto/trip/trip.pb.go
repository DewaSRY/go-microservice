...
type RideFare struct {
	...
	TotalPriceInCets float64                `protobuf:"fixed64,4,opt,name=totalPriceInCets,proto3" json:"totalPriceInCets,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *RideFare) GetTotalPriceInCets() float64 {
	if x != nil {
		return x.TotalPriceInCets
	}
	return 0
}
...
const file_trip_proto_rawDesc = "" +
	...
	"\x10totalPriceInCets\x18\x04 \x01(\x01R\x10totalPriceInCets\">\n" +
	"\bGeometry\x122\n" +
	"\vcoordinates\x18\x01 \x03(\v2\x10.trip.CoordinateR\vcoordinates2Q\n" +
	"\vTripService\x12B\n" +
	"\vPreviewTrip\x12\x18.trip.PreviewTripRequest\x1a\x19.trip.PreviewTripResponseB\x13Z\x11shared/proto/tripb\x06proto3"
...
var file_trip_proto_depIdxs = []int32{
	...
	4, // 3: trip.PreviewTripResponse.rideFares:type_name -> trip.RideFare
	5, // 4: trip.Route.geometry:type_name -> trip.Geometry
